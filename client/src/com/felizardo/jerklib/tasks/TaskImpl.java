package com.felizardo.jerklib.tasks;
...
import com.felizardo.jerklib.listeners.TaskCompletionListener;
 ...
 * @see Session#onEvent(jerklib.tasks.Task, com.felizardo.jerklib.events.IRCEvent.Type...)
 * @see Type
 * 
 * @author mohadib
 *
